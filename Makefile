...
# Source files
KERNEL_SRC = boostrap.c vga.c serial.c debug.c
KERNEL_OBJ = $(BUILD_DIR)/boostrap.o $(BUILD_DIR)/vga.o $(BUILD_DIR)/serial.o $(BUILD_DIR)/debug.o
...
$(BUILD_DIR)/boostrap.o: boostrap.c debug.h | $(BUILD_DIR)
	$(CC) $(CFLAGS) -c $< -o $@
